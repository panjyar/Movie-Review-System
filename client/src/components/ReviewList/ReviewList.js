...
const ReviewList = ({ movieId, initialReviews = [] }) => {
  ...
  const loadReviews = useCallback(async (pageNum = 1, replace = false) => {
  ...
  }, [movieId, sortBy]); // Dependency array is now stable.
    ...
    <div className={styles.reviewSection}>
      ...
      <div className={styles.reviewList}>
        {reviews.length > 0 ? (
          ...
          !loading && <p>No reviews yet. Be the first to share your thoughts!</p>
        )}
      </div>
